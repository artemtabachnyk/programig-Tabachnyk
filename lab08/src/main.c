/**
*       @file main.c  Визначити просте чи складене число 
...
//}
/**
*	Фунція в якій буде виконуватися основна дія(Шукати просте чи складене число)
*  	@param aaa число яке ми будемо визначати просте чи складене
*	@param ууу кількість дільників на яке число ааа ділиться без остачі
*       @param iii число на яке ділиться число ааа(з кожним колом цикла збільшується на 1)
*	
*
*/
...
*	@param ххх змінна яка буде передаватися в функцію number для виконання задачі(визначате просте чи складне число)
*	@param ggg змінна за допомогою якої ми вибираємо спосіб роботи программи
*/
